<template>
  <div class="tab_content">
    ...
    <div class="tabImg" style="max-width: 900px">
      <img v-if="lang" class="w-100" src="/images/tabImg/115.jpg" alt="" />
      <img v-else class="w-100" src="/images/tabImg/115uz.jpg" alt="" />
    </div>
    ...
    <div class="tab_content-block mt-3">
      ...
      >
        <img v-if="lang" src="/images/tabImg/116.jpg" alt="" />
        <img v-else src="/images/tabImg/116uz.png" alt="" />
      </div>
    </div>
    <div class="tab_content-block">
      ...
      <div class="tabImg" style="max-width: 900px">
        <img v-if="lang" src="/images/tabImg/117.jpg" alt="" />
        <img v-else src="/images/tabImg/117uz.png" alt="" />
      </div>
    </div>
    <div class="tab_content-block">
      <div class="tab_content-title">
    ...
    <div class="tabImg" style="max-width: 900px">
      <img v-if="lang" src="/images/tabImg/118.jpg" alt="" />
      <img v-else src="/images/tabImg/118uz.png" alt="" />
    </div>
  </div>
</template>
<script>
